...
package com.huaxing.framework.feign.ext;
 ...
 */
@Slf4j
public class BlogSentinelInvocationHandler implements InvocationHandler {
	...
	BlogSentinelInvocationHandler(Target<?> target, Map<Method, InvocationHandlerFactory.MethodHandler> dispatch,
	...
	public Object invoke(final Object proxy, final Method method, final Object[] args) throws Throwable {
		...
		// only com.huaxing.framework.feign.handle by HardCodedTarget
		if (target instanceof Target.HardCodedTarget) {
			...
			if (methodMetadata == null) {
				...
				try {
					...
					// fallback com.huaxing.framework.feign.handle
	...
	public boolean equals(Object obj) {
		if (obj instanceof SentinelInvocationHandler) {
			BlogSentinelInvocationHandler other = (BlogSentinelInvocationHandler) obj;
