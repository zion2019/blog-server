package com.huaxing.framework.core.jackson.component;

import com.huaxing.framework.core.jackson.annotation.JacksonFilter;
import com.huaxing.framework.core.jackson.annotation.JacksonFilters;
import com.huaxing.framework.core.jackson.core.JacksonFilterBean;
...
public class JacksonFiltersComponent {
     ...
     * @return void
     */
    @Pointcut("@annotation(com.huaxing.framework.core.jackson.annotation.JacksonFilters) "
            + "|| @annotation(com.huaxing.framework.core.jackson.annotation.JacksonFilter)")
    ...
    private Object[] jacksonRequestFilterHanlder(ProceedingJoinPoint joinPoint, List<JacksonFilter> requestFilters,
        ...
        if (inclueFiltFields != null) {
            objectMapper = getMixObjectMapper(clazz, JacksonFilterBean.IncomeParameterIncludeFillter.class, inclueFiltFields,
                    JacksonFilterBean.INCOME_PARAMETER_INCLUDE_FILTER, true);
        } else if (exclueFiltFields != null) {
            objectMapper = getMixObjectMapper(clazz, JacksonFilterBean.IncomeParameterExcludeFillter.class, exclueFiltFields,
    ...
    private Object jacksonResponseFilterHanlder(ProceedingJoinPoint joinPoint, List<JacksonFilter> responseFilters,
        ...
        ObjectMapper objectMapper = null;
        if (inclueFiltFields != null) {
            objectMapper = getMixObjectMapper(clazz, JacksonFilterBean.OutcomeParameterIncludeFillter.class, inclueFiltFields,
                    JacksonFilterBean.OUTCOME_PARAMETER_INCLUDE_FILTER, true);
        } else if (exclueFiltFields != null) {
            objectMapper = getMixObjectMapper(clazz, JacksonFilterBean.OutcomeParameterExcludeFillter.class, exclueFiltFields,
