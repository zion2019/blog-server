...
import com.huaxing.resource.security.exception.*;
 ...
 */
@Slf4j
public class HbWebResponseExceptionTranslator implements WebResponseExceptionTranslator {
	...
	private ResponseEntity<OAuth2Exception> handleOAuth2Exception(OAuth2Exception e) {
		...
		return new ResponseEntity<>(new HbAuth2Exception(e.getMessage(), e.getOAuth2ErrorCode()), headers,
